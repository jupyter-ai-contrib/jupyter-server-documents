...
class KernelMessageCache:
    ...
    _by_cell_id: dict
    _by_msg_id: OrderedDict
    _maxsize: int

    def __init__(self, maxsize=10000):
        """
        Initializes the KernelMessageCache.

        Args:
            maxsize (int, optional): The maximum number of messages to store.
                                     Defaults to 10000.
        """
        self._by_cell_id = {}
        self._by_msg_id = OrderedDict()
    ...
    def __getitem__(self, key):
        ...
        """
        out = self._by_msg_id[key]
        self._by_msg_id.move_to_end(key)
        return out
    ...
    def __setitem__(self, key, value):
        ...
        Raises:
            Exception: If the key does not match the message ID in the value,
        ...
        self._by_msg_id[key] = value
        if len(self._by_msg_id) > self._maxsize:
            self._remove_oldest()
    ...
    def __contains__(self, key):
        ...
        """
        return key in self._by_msg_id

    def __iter__(self):
        """
        Returns an iterator over the message IDs in the cache.
        """
        for key in self._by_msg_id:
            yield key
