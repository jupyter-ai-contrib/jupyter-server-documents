...
class YNotebook(UpstreamYNotebook):
    ...
    def set_cell_metadata(self, cell_id: str, namespace: str, data) -> None:
        """Replace the entire namespace in a cell's metadata."""
        _, cell = self.find_cell(cell_id)
        if cell is None:
            return
        cell["metadata"][namespace] = data

    def update_cell_metadata(self, cell_id: str, namespace: str, **fields) -> None:
    ...
    def get_cell_metadata(self, cell_id: str, namespace: str) -> dict:
    ...
    def remove_cell_metadata(self, cell_id: str, namespace: str) -> None:
